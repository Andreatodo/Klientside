$("#createQuizBtn").click(function(e){
    ...
    console.log(quiz);
    $.ajax({
        type: 'POST', // Vi sender data til serveren som bliver oprettet ved oprettelse af quiz
        url: apiURL + '/quiz/',
        dataType: 'json',
        contentType: 'application/json',
        headers: {"Authorization": localStorage.getItem("token")}, //før vi får lov at oprette en quiz, foretager vi en Authorization af brugerens token
